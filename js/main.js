...
(function ($) {
	...
	var Venedor = {
		...
		priceSlider: function () {
			...
			if ($.fn.noUiSlider) {
				$('#price-range').noUiSlider({
					...
					step: 1,
					serialization: {
						to: [ $('#price-ranbt-low'), $('#price-ranbt-high') ],
						resolution: 1
					}
				});
			}
		...
		owlCarousels: function () {
			...
			/*  Brand Slider */			
			var  bottomSlider = $('div.bottom-slider.owl-carousel');
			if (self.checkSupport(bottomSlider, $.fn.owlCarousel)) {
		        bottomSlider.owlCarousel({
		            ...
		            responsive: true,
		            autoHeight : true
		        }).data('navigationBtns', ['#bottom-slider-prev', '#bottom-slider-next']);
		    }
				
			/*  Brand Slider */			
			var  santeSlider = $('div.sante-slider.owl-carousel');
			if (self.checkSupport(santeSlider, $.fn.owlCarousel)) {
		        santeSlider.owlCarousel({
		            items: 2,
		            itemsDesktop : [1199,2],
		            ...
		            responsive: true,
		            autoHeight : true
		        }).data('navigationBtns', ['#sante-slider-prev', '#sante-slider-next']);
		    }
		...
		flexsliders: function () {
			...
			if ($.fn.flexslider) {
				...
				$('.category-imabt-slider.flexslider').flexslider({
					animation: "slide",
					animationLoop: true,
					prevText: '',
					nextText: '',
		...
		parallax: function () {
			...
			if (!Venedor.mobile && $.fn.parallax) {
				$('#pabt-header').addClass('parallax').parallax("50%", 0.4);
